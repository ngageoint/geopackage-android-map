...
public class GoogleMapShapeConverter {
     ...
     * @return true if near
     */
    private static boolean isPointNearMarker(LatLng point, MarkerOptions shapeMarker, double tolerance) {
     ...
     * @return true if near
     */
    private static boolean isPointNearPoint(LatLng point, LatLng shapePoint, double tolerance) {
     ...
     * @return true if near
     */
    private static boolean isPointNearMultiLatLng(LatLng point, MultiLatLng multiLatLng, double tolerance) {
        boolean near = false;
     ...
     */
    private static boolean isPointOnPolyline(LatLng point, PolylineOptions polyline, boolean geodesic, double tolerance) {
     ...
     */
    private static boolean isPointOnMultiPolyline(LatLng point, MultiPolylineOptions multiPolyline, boolean geodesic, double tolerance) {
        boolean near = false;
