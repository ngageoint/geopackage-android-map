package mil.nga.geopackage.map.test.tiles.features;
...
public class FeatureTileUtils {
    ...
    public static FeatureTiles createFeatureTiles(Context context, GeoPackage geoPackage, FeatureDao featureDao) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), mil.nga.geopackage.map.test.R.drawable.ic_launcher);
