...
Pull from the [Maven Central Repository](http://search.maven.org/#artifactdetails|mil.nga.geopackage.map|geopackage-android-map|6.1.0|aar) (AAR, POM, Source, Javadoc)

    api 'mil.nga.geopackage.map:geopackage-android-map:6.1.0'
